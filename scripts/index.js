...
link.style.background = "linear-gradient(90deg, red, orange, yellow, green, cyan, blue, violet)";
link.style.backgroundSize = "300%";
...
let countDown = new Date(`${config.birthdate} 17:45:00`).getTime();
x = setInterval(function() {
  ...
  let w = (c.width = window.innerWidth),
    ...
    hh = h / 2,
    opts = {
      strings: ['TE QUIERO', 'MI AMOR!', config.name],
      charSize: 30,
      charSpacing: 35,
      lineHeight: 40,
